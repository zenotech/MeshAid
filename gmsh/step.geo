...
Transfinite Line {2,3,4,5,6,8,9,10} = 20; // We want 40 points along each of these lines
...
Extrude {0, 0, extr} { Surface{1,2,3}; Layers{1}; Recombine;}


Physical Surface("wall") = {67,71,19};
Physical Surface("inflow") = {45, 63,41,27};
